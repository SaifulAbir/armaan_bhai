...
class OTPVerifyAPIVIEW(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if otp_obj.otp_number == serializer.data["otp_number"]:
            ...
            otp_obj.save()
            return Response(
                {"user_id": user.id, "image": user.image.url if user.image else None, "user_type": user.user_type, "full_name": user.full_name, "phone_number": user.phone_number, 'details': 'Verified',
